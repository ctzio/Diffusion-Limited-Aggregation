            ...
            for(int j=a->getY()-1;j<a->getY()+2;j++)
            {
                ...
                if(screen[i][j]!=0)
                {
                    if(screen[i][j]-(a->getType())!=0)
                    {
                        ...
                        {
  //                        cout<<"Atom 12 is stuck at ("<<a->getX()<<","<<a->getY()<<")";
  //                        cout<<endl<<endl;
                            return true;
                        }
                    }
     ...
     //                   cout<<randomsticky<<"\n";
                        ...
                        {
    //                      cout<<"Atom 1 is stuck at ("<<a->getX()<<","<<a->getY()<<")";
    //                      cout<<endl<<endl;
                            return true;
                        }
                    }
                    else if((screen[i][j]==2) && (a->getType())==2)
                    {
                        //checking if the atom will stick
                        randomsticky=rand()%101;
                        if(randomsticky<sticky22)
                        {
      //                   cout<<"Atom 2 is stuck at ("<<a->getX()<<","<<a->getY()<<")";
      //                    cout<<endl<<endl;
                            return true;
