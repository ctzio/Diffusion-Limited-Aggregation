...
int main(void)
{
    ...
    screenTxtImg.open("screen.txt", ios::out | ios::trunc);
    ...
    screenFullTxtImg.open("fullscreen.txt", ios::out | ios::trunc);
    ...
    screenFullBmp.WriteToFile("screenFullBmp.bmp");
   ...
   // Getting the values for surface to volume.
    ...
    SurftoVol<<surtov1<<","<<surtov2<<","<<surtov12<<"\n";



    screenFullSurfaceImg.open("fullsurface.txt", ios::out | ios::trunc);
 ...
 //creating a bitmap image of the cluster represented in screen with the surface
    ...
    //write the bitmap to file
    screenFullSurfaceBmp.WriteToFile("screenFullSurface.bmp");
