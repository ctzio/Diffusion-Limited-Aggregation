...
//            cout<<"Spot is occupied: X,Y reverted"<<endl<<endl;
        ...
        if(screen[a->getX()][j]!=0)
        {


                    //checking if the atom will stick

                    if(screen[a->getX()][j]-(a->getType())!=0)
                    {
...
//                      cout<<endl<<endl;
                    ...
                    else if((screen[a->getX()][j]==1) &&(a->getType()==1))
                    {
...
//                          cout<<endl<<endl;
                    ...
                    else if((screen[a->getX()][j]==2) &&(a->getType()==2))
                    {
                        //checking if the atom will stick
                        randomsticky=rand()%101;
...
//                          cout<<endl<<endl;
               ...
               //downwards stick
        if(screen[a->getX()][l]!=0)
        {


                    //checking if the atom will stick

                    if(screen[a->getX()][l]-(a->getType())!=0)
                    {
...
//                      cout<<endl<<endl;
                    ...
                    else if((screen[a->getX()][l]==1) &&(a->getType()==1))
                    {
...
//                          cout<<endl<<endl;
                    ...
                    else if((screen[a->getX()][l]==2) &&(a->getType()==2))
                    {
                        //checking if the atom will stick
                        randomsticky=rand()%101;
                        if(randomsticky<sticky22)
...
//                          cout<<endl<<endl;
         ...
         if(screen[i][a->getY()]!=0)
         {
                    ...
                    if(screen[i][a->getY()]-(a->getType())!=0)
                    {
...
//                      cout<<endl<<endl;
                    ...
                    else if((screen[i][a->getY()]==1) &&(a->getType()==1))
                    {
...
//                          cout<<endl<<endl;
                    ...
                    else if((screen[i][a->getY()]==2) &&(a->getType()==2))
                    {
                        //checking if the atom will stick
                        randomsticky=rand()%101;
                        if(randomsticky<sticky22)
...
//                          cout<<endl<<endl;
                ...
                //right stick
                if(screen[k][a->getY()]!=0)
                   {


                    //checking if the atom will stick

                    if(screen[k][a->getY()]-(a->getType())!=0)
                    {
...
//                      cout<<endl<<endl;
                    ...
                    else if((screen[k][a->getY()]==1) &&(a->getType()==1))
                    {
...
//                          cout<<endl<<endl;
                    ...
                    else if((screen[k][a->getY()]==2) &&(a->getType()==2))
                    {
                        //checking if the atom will stick
                        randomsticky=rand()%101;
                        if(randomsticky<sticky22)
